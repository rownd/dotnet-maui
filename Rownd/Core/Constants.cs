...
namespace Rownd.Maui.Core
{
    public static class Constants
    {
        ...
        public static readonly string DEFAULT_API_USER_AGENT = $"Rownd SDK for .NET MAUI/{sdkVersion} (Language C#; Platform={DeviceInfo.Platform} {DeviceInfo.VersionString}; (SDK {sdkVersion});)";
        public static readonly string DEFAULT_WEB_USER_AGENT = $"Rownd SDK for .NET MAUI/{sdkVersion} (Language C#; Platform={DeviceInfo.Platform} {DeviceInfo.VersionString}; (SDK {sdkVersion});)";
